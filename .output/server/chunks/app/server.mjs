...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-f4a21496.mjs').then((m) => m.default || m)
  },
  {
    name: "accord",
    path: "/accord",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/accord-32f2fe1c.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-427e1470.mjs').then((m) => m.default || m)
  },
  {
    name: "map",
    path: "/map",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/map-e428fcf8.mjs').then((m) => m.default || m)
  },
  {
    name: "mobile",
    path: "/mobile",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/mobile-bf570654.mjs').then((m) => m.default || m)
  },
  {
    name: "scalePage",
    path: "/scalePage",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/scalePage-00cae77c.mjs').then((m) => m.default || m)
  },
  {
    name: "start",
    path: "/start",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/start-a90f2dab.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-39ce54b6.mjs').then((r) => r.default || r));
